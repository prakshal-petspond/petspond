...
export default function LegacyDashboardPage() {
  ...
  if (isAdmin) {
    navTabs.push(['clinic', 'Clinic profile'], ['invites', 'Invites']);
  }
        ...
        <div className="flex flex-wrap gap-2 border-b border-border mb-6 pb-1">
          ...
          {isAdmin ? (
            <button
              ...
              className="pb-3 px-3 text-sm font-medium border-b-2 border-transparent text-muted hover:text-foreground transition-colors"
            >
              Team
            </button>
          ) : null}
